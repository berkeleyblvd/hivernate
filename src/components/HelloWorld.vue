          ...
          <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
            <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div class="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">We’re changing the way corporations innovate.</h1>
                <p class="mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">We help corporations looking to grow through innovation by quickly translating business problems into new ventures. We then connect promising opportunities to world-class founders and investors to launch a new technology venture.</p>
                <div class="mt-10 flex items-center gap-x-6">
                  ...
                  <router-link to="/application" class="text-sm font-semibold leading-6 text-gray-900">Corporate Partner Application <span aria-hidden="true">→</span></router-link>
                </div>
              </div>
